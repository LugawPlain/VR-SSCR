  ...
  init: function () {
    ...
    this.el.addEventListener("mousedown", (event) => {
      ...
      this.el.addEventListener("mouseup", () => {
        ...
        // console.log(cursor);
        // cursor.removeAttribute("super-hands");
        // cursor.setAttribute(
        //   "super-hands",
        //   "colliderEvent: raycaster-intersection; colliderEventProperty: els; colliderEndEvent: raycaster-intersection-cleared; colliderEndEventProperty: clearedEls;"
        // );
...
function setToggle(toggle) {
  ...
  if (toggle) {
    gates.forEach((entity) => {
      entity.setAttribute("logic-gate", { setEdit: true });
    });
    ...
    gates.forEach((entity) => {
      entity.setAttribute("logic-gate", { setEdit: false });
    });
    nodes.forEach((entity) => {
